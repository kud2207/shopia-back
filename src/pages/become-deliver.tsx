          ...
          <div className='row'>
            <div className='col-lg-6 col-md-12' data-aos='fade-right' data-aos-duration='1500'>
              ...
              <ul className='app_btn'>
                <li>
                  <a href='/register?u=livreur'>{t('begin_now')}</a>
                </li>
              </ul>
            </div>

            <div className='col-lg-6 col-md-6' data-aos='fade-in' data-aos-duration='1500'>
              <img
                className='moving_position_animatin'
                style={{ borderRadius: '150px 1px' }}
...
HomePage.getLayout = (page: ReactNode) => <LandingLayout route='/register?u=livreur'>{page}</LandingLayout>
