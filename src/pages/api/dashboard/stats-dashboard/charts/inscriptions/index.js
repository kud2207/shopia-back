/**
 * @swagger
 * /api/dashboard/stats-dashboard/charts/inscriptions:
 *   get:
 *     summary: Évolution des inscriptions
 *     description: |
 *       Retourne le nombre de nouvelles inscriptions par période (jour, semaine ou mois).
 *       
 ...
 *                 data:
 *                   type: array
 *                   description: Liste des inscriptions par période
 *                   items:
 *                     type: object
 *                     properties:
 *                       mois:
 ...
 *                       value:
 *                         type: integer
 *                         description: Nombre d'inscriptions pour cette période
 *                         example: 353
 *
 *                   example:
 *                     - mois: mars
